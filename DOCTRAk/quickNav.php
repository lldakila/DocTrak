...
//    die();
    ...
    $con=mysqli_connect($DB_HOST,$DB_USER,$DB_PASS,$BD_TABLE);
		...
		$sql="SELECT sort,office_description,template_name,template_description,docprocess FROM document_template join template_list on document_template.template_id = template_list.fk_template_id
