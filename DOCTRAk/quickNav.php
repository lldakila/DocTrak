...
switch($formModule)
{
    ...
    case 'renderNewDocTemplate':
    renderTemplateInfo($_POST['template_id']);
    break;
...
//                                     $query=select_info_multiple_key("select DOCUMENTTYPE_ID from document_type");
                        ...
                        <div id='docTempDetail'  style='max-height:200px; overflow:auto'></div>
...
//    die();
	...
	//////////////////////
	//FUNCTION TO GET AND RETRIEVE DOCUMENT TEMPLATE
	////////////////////////////////
	function renderTemplateInfo($template_name)
	{
		global $DB_HOST, $DB_USER,$DB_PASS, $BD_TABLE;
    $con=mysqli_connect($DB_HOST,$DB_USER,$DB_PASS,$BD_TABLE);
		
		$sql="SELECT sort,office_description,template_name,template_description FROM document_template join template_list on document_template.template_id = template_list.fk_template_id
		join office on template_list.fk_office_name=office.office_name WHERE template_id = '".$_POST['template_id']."' ";
		...
		echo "<p>";
		echo "Template : <b>".$resultRow['template_name']."</b>";
		echo "<br>";
		echo "Description : <b>".$resultRow['template_description']."</b>";
		echo " 
				<table class='table table-bordered table-striped'><tr><td><b>Step</b></td><td><b>Office</b></td></tr>
	...
	//////////////////////
	//END FUNCTION TO GET AND RETRIEVE DOCUMENT TEMPLATE
	////////////////////////////////
