...
<div class="menubg">
            	...
            	<div class="menugroup">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                echo '
                                <li role="presentation" class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="' ?><?php echo $PROJECT_ROOT."procedures/home/bac/bac.php"; ?><?php echo' role="button" aria-expanded="false">
                                        BAC <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu down-bgcolor" role="menu">
                                        <li><a href=' ?><?php echo $PROJECT_ROOT."procedures/home/bac/new.php"; ?><?php echo'><span>New</span></a></li>
                                        <li><a href=' ?><?php echo $PROJECT_ROOT."procedures/home/bac/checkin.php"; ?><?php echo'><span>Check In</span></a></li>
                                        <li class="divider linebgcolor"></li>
                                        <li><a href=' ?><?php echo $PROJECT_ROOT."procedures/home/bac/checkin.php"; ?><?php echo'><span>Monitoring</span></a></li>
                                    </ul>
        ...
        <div class="admin">
	         ...
	         while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
	         {
                     ...
                     if ($row['mailcount']<>0)
                     {
		         echo '<span class="badge"><a href="'.$PROJECT_ROOT.'procedures/home/userinfo/inbox.php"><img src="'.$PROJECT_ROOT.'images/home/icon/testmail.gif" width="30" height="20" align="left" /></a>'.$row['mailcount'].'</span>&nbsp';
                         break;
                     }
	         }
                 
                 
           echo "<p>Hi, <a href=".$PROJECT_ROOT."procedures/home/userinfo/userinfo.php>".$_SESSION['security_name']."</a> of ".$_SESSION['OFFICE']."</p>";
