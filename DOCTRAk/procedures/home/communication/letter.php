											    ...
											    <form id="data" class="myForm" name="data" method="post"  enctype="multipart/form-data">
												    	...
												    	<div class="table1 form-horizontal">
											      			...
											      			<div class="form-inline">
																		    ...
																		    <label class="col-sm-2 control-label"  for="exampleInputEmail2">Send to:</label>
																		      <div class="col-sm-9">
...
//																					        }
																		 ...
																		 <div class="col-sm-1">
																		  ...
																		  <input type="button" value="+" onClick="javascript:addoffice();" class="btn btn-primary glyphicon glyphicon-plus" />
																		</div>
																		   </div>
																  </div>
																  ...
																  <div class="form-inline" style="margin-top:10px;">
																			...
																			<div class="form-group" id="RemoveWidth">
																				
																		    <label style="padding-right:82px" for="exampleInputEmail2"></label>
