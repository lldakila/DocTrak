...
//		    $counterA++;
		    ...
		    array_push($resultArray, array("no"=>$counterA,"barcode"=>"<span id='".$counterA."' class='barcode'>".$resultSet['document_id']."</span>","title"=>"<span class='title'>".$resultSet['document_title']."</span>","office"=>"<span class='office'>".$resultSet['office_description']."</span>","owner"=>"<span class='owner'>".$resultSet['security_name']."</span>","date"=>"<span class='date'>".date_format(date_create($resultSet['transdate']), 'F d, Y')."</span>"));
