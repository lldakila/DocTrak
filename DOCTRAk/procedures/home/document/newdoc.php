...
<!--                            <input id="generatebarcode" type="button" value="Generate" class="btn btn-primary"/></td>-->
    ...
    ?>
       ...
       <?php
           ...
           echo "</select></td>";
					echo "<td><a class='viewTemplateLinks' target='_blank' id ='viewTemplateLink' style='color:#000;'  href='".$PROJECT_ROOT."'/procedures/home/document/common/viewtemplate.php?template_id=".$var['TEMPLATE_ID']."'>View Template</a></td>";
