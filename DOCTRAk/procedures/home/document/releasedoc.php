								...
								<hr class="hrMargin" style="margin-bottom:10px;">
									<form name="process" method="post" action="release/process.php" onsubmit="return validate();" enctype="multipart/form-data">
										...
										<div class="table1 form-horizontal">
											...
											<div class="input1">
												<input type="submit" class="btn btn-primary" id="btn" value="Release" onClick="document.getElementById('releasedoc_hidden').value='release';"/>
											</div>
							...
							<div id="postright0" class="col-xs-6 col-md-4">
								...
								<form id="tfnewsearch" method="post">
									...
									<span class="input-group-btn">
										<button id="search_releasedoc" class="btn btn-default btn-search">Search </button>
									</span>
									</div>		
