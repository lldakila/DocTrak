			...
			<table class="setup" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<table class="setup" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100" align="center">School Code</td>
							...
							$result = mysqli_query($con, "SELECT * FROM school order by idschool");
							...
							while($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
								...
								echo "
									<tr bgcolor='$color' onclick='javascript:window.location.href='school_view.php?'>
									<td>".$row['schoolcode']."</td>
									<td>".$row['schooldesc']."</td>
									<td align=center><a onclick='edit(".$row['idschool'].");'>"."<img src='images/edit.png' height='12px'/></a></td>
									</tr>
								";$i++;
							}			
							mysqli_close($con);
				...
				<tr>
					<td align="right"><input type="button" value="Add" style="height:25px; width:60px" onclick="window.location.href=('school_add.php')"></td>
				</tr>
			</table>
			</td>
