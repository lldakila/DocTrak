	...
	<table>
		<tr>
			...
			<table class="setup" cellpadding="0" cellspacing="0">
					...
					<td>	
						<table class="setup" align="left">
							<tr>
								...
								<td width="150px" align="left" >Barangay Code :&nbsp;&nbsp;   </td>
				...
				<tr>
					<td align="right">
						<a onclick="window.location.href='barangay_browse.php'"><input type="button" value="Browse" style="height:25px; width:60px"></a> &nbsp;
						<a onclick="window.location.href='barangay_add.php'"><input type="button" value="Add" style="height:25px; width:60px"></a>
