...
<div class="scholar">
	<table>
		<tr>
			...
			<!--edit here-->
			<td valign="top">
			<form method="post" onsubmit="return validateForm()" name="setupForm" action="office_addsave.php">
					...
					<td width="250">
						<table class="setup" align="left">
							<tr>
								...
								<td colspan="2"><input type="text" id="officecode" name="officecode"></td>
							</tr>
							<tr>
								<td  align="right">Name : &nbsp;&nbsp;</td>
								<td colspan="2"><input type="text" id="officedesc" name="officedesc" size="50"></td>
							</tr>
						</table>
					</td>
				</tr>
