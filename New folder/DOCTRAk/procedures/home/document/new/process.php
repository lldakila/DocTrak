...
//            }
            ...
            $sqlquery="insert into documentlist_history(fk_documentlist_id,fk_officename,document_process,transdate,document_comment,document_details) values ('".$_POST['barcode']."','".$_SESSION['OFFICE']."','Document Created','".date("Y-m-d H:i:s")."','',Created by'".$_SESSION['security_name']."')";
