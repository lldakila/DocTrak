...
$(document).ready(function() {
    ...
    jQuery.ajax({
			type: "POST",
            url:"procedures/home/maintenance/security/user/search.php",
    	...
    	<div class="content2">
        	...
        	<div id="post">
                        ...
                        <h2>USERS</h2>
                             ...
                             <form name="process" method="post" action="procedures/home/maintenance/security/user/process.php" onsubmit="return validate();">
