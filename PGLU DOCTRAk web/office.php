...
$(document).ready(function() {
    $("#search_office").click(function (e) {
        ...
        jQuery.ajax({
            type: "POST",
            url:"procedures/home/maintenance/office/search.php",
    	...
    	<div class="content2">
        	...
        	<div id="post">
                        ...
                        <h2>OFFICES</h2>
                         ...
                         <form name="process" method="post" action="procedures/home/maintenance/office/process.php" onsubmit="return validate();">
