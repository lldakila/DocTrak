...
<html>
	<head>
		...
		function edit(id)
        {
          window.location="office_edit.php?id="+id;
        }
		</script>
	</head>
			...
			<table class="setup" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<table class="setup" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100" align="center">Office Code</td>
							...
							$result = mysqli_query($con, "SELECT * FROM office order by idoffice");
							...
							while($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
								...
								echo "
									<tr bgcolor='$color' onclick='javascript:window.location.href='office_view.php?'>
									<td>".$row['officecode']."</td>
									<td>".$row['officedesc']."</td>
									<td align=center><a onclick='edit(".$row['idoffice'].");'>"."<img src='images/edit.png' height='12px'/></a></td>
									</tr>
								";$i++;
							}			
							mysqli_close($con);
				...
				<tr>
					<td align="right"><input type="button" value="Add" style="height:25px; width:60px" onclick="window.location.href=('office_add.php')"></td>
				</tr>
			</table>
			</td>
