...
<div class="scholar">
	<table>
		<tr>
			...
			<!--edit here-->
			<td valign="top">
			<form method="post" action="office_addsave.php">
			<table class="setup" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td>	
						<table class="setup" align="left">
							<tr>
								<td width="150px" align="right" >Course Code :&nbsp;&nbsp;   </td>
							...
							<tr>
								...
								<td colspan="2"> <?php echo"".$_SESSION['viewfield']."";  ?></td>
							</tr>							
						</table>
					</td>
				</tr>
				<tr>
					<td align="right">
						<a onclick="window.location.href='course_browse.php'"><input type="button" value="Browse" style="height:25px; width:60px"></a> &nbsp;
						<a onclick="window.location.href='course_add.php'"><input type="button" value="Add" style="height:25px; width:60px"></a>
					</td>
				</tr>		
			</table>
			</form>
