...
<html>
	<head>
		...
		<script language="JavaScript" type="text/javascript">
		 ...
		 function edit(id)
        {
          window.location="municipality_edit.php?id="+id;
         }
	</script>
	</head>
			...
			<table class="setup" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<table class="setup" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100" align="center">Municipal Code</td>
							...
							while($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
								...
								echo "
									<tr bgcolor='$color' onclick='javascript:window.location.href='municipality_view.php?'>
									<td>".$row['muncode']."</td>
									<td>".$row['mundesc']."</td>
									<td align=center><a onclick='edit(".$row['idmun'].");'>"."<img src='images/edit.png' height='12px'/></a></td>
									</tr>
								";$i++;
							}			
							mysqli_close($con);
				...
				<tr>
					<td align="right"><input type="button" value="Add" style="height:25px; width:60px" onclick="window.location.href=('municipality_add.php')"></td>
				</tr>
			</table>
			</td>
