...
<div class="scholar">
	<table>
		<tr>
			...
			<!--edit here-->
			<td valign="top">
			<form method="post" onsubmit="return validateForm()" name="setupForm" action="municipality_addsave.php">
			<table class="setup" cellpadding="0" cellspacing="0">
				<tr>
					<td>Add - MUNICIPALITY</td>
				</tr>	
					...
					<td width="250">
						<table class="setup" align="left">
							<tr>
								...
								<td colspan="2"><input type="text" id="muncode" name="muncode"></td>
							</tr>
							<tr>
								<td  align="right">Name : &nbsp;&nbsp;</td>
								<td colspan="2"><input type="text" id="mundesc" name="mundesc" size="50"></td>
							</tr>
						</table>
					</td>
				</tr>
