...
<html>
	<head>
		...
		function edit(id)
        {
          window.location="scholartype_edit.php?id="+id;
        }
		</script>
	</head>
			...
			<table class="setup" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<table class="setup" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100" align="center">Scholar Type Code</td>
							<td width="300" align="center">Name</td>
							<td width="50" align="center">Slot</td>
							...
							$result = mysqli_query($con, "SELECT * FROM type order by idtype");
							...
							while($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
								...
								echo "
									...
									<td>".$row['typedesc']."</td>
									<td>".$row['typeslot']."</td>
									<td align=center><a href='scholartype_edit.php'>"."<img src='images/edit.png' height='12px'/></a></td>
									</tr>
								";$i++;
							}			
							mysqli_close($con);
				...
				<tr>
					<td align="right"><input type="button" value="Add" style="height:25px; width:60px" onclick="window.location.href=('scholartype_add.php')"></td>
				</tr>
			</table>
			</td>
